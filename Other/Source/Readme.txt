...
user in an INI file next to HDDRawCopyPortable.exe called HDDRawCopyPortable.ini.
...
copy AppNamePortable.ini from this directory to HDDRawCopyPortable.ini next to
HDDRawCopyPortable.exe. The options in the INI file are as follows:
